...
public class ReturnedDialog extends javax.swing.JDialog {
    ...
    public ReturnedDialog() {
        setModal(true);
        partModel.loadReturnedParts();
        vehicleModel.loadReturnedVehicles();
        initComponents();
    ...
    private void initComponents() {
        this.setTitle("GMSIS SPC booking / Returned vehicles and parts");
        ...
        vehiclesLabel.setText("Returned vehicles");

        partsLabel.setText("Returned parts");
